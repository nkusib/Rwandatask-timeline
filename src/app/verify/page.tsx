    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white rounded-2xl p-8 border border-gray-100 text-center">
          ...
          <div className="bg-blue-50 rounded-xl p-3 text-xs text-[#0D1DBD] mb-6 text-left space-y-1">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="date" value={personal.dob}
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#1326FD]" />
              </div>
              <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <select value={idForm.idType}
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#1326FD]">
              ...
              <div>
                ...
                <input type="text" value={idForm.idNumber} placeholder="e.g. 123456789"
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#1326FD] font-mono" />
              </div>
              ...
              {cameraActive && cameraMode === 'id' ? (
                <div className="relative rounded-xl overflow-hidden bg-black">
                  ...
                  <div className="absolute inset-0 border-4 border-[#1326FD] border-dashed rounded-xl pointer-events-none" />
                  <div className="absolute bottom-0 left-0 right-0 p-3 flex gap-2 justify-center bg-gradient-to-t from-black/60">
                    <button onClick={capturePhoto}
                      className="px-6 py-2 rounded-full bg-[#161618] text-white text-sm font-semibold hover:bg-[#0D1DBD]">
                      Capture photo
                    </button>
                ...
                >
                  <Camera className="w-8 h-8 text-gray-400 group-hover:text-[#1326FD] mx-auto mb-2 transition-colors" />
            ...
            {cameraActive && cameraMode === 'selfie' ? (
              <div className="relative rounded-xl overflow-hidden bg-black">
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <div className={`w-40 h-52 border-4 rounded-full transition-colors ${livenessProgress >= 100 ? 'border-emerald-400' : 'border-[#1326FD]'} opacity-80`} />
                </div>
                ...
                <div className="absolute top-12 left-4 right-4">
                  <div className="h-1 bg-white/20 rounded-full overflow-hidden">
                    <div
                      className={`h-full rounded-full transition-all duration-200 ${livenessProgress >= 100 ? 'bg-[#008F5A]' : 'bg-[#1326FD]'}`}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-3 flex gap-2 justify-center bg-gradient-to-t from-black/60">
                  <button onClick={capturePhoto}
                    ...
                    className="px-6 py-2 rounded-full bg-[#161618] text-white text-sm font-semibold hover:bg-[#0D1DBD] disabled:opacity-40 disabled:cursor-not-allowed">
              ...
              >
                <Camera className="w-10 h-10 text-gray-400 group-hover:text-[#1326FD] mx-auto mb-2 transition-colors" />
            ...
            {biometricDone ? (
              ...
              <div className="space-y-4">
                <div className="bg-blue-50 rounded-xl p-4 space-y-2">
                  <div className="flex items-center gap-2 text-[#0D1DBD] font-semibold text-sm">
                    <Fingerprint className="w-5 h-5" /> What you can use:
                  </div>
                  <div className="text-xs text-[#0D1DBD] space-y-1">
        ...
        {currentStep === 4 && (
          <div className="bg-white rounded-2xl p-6 border border-gray-100">
            ...
            <div className="bg-gray-50 rounded-xl p-4 text-xs text-gray-500 mb-5">
              ...
              <a href="/privacy" className="text-[#1326FD] underline">Privacy Policy</a> and GDPR.
            </div>
  ...
  return (
    <div className="flex items-center justify-between py-2 border-b border-gray-50">
      ...
      <div className="flex items-center gap-2">
        ...
        <button onClick={() => onEdit(step)} className="text-xs text-[#1326FD] hover:underline">Edit</button>
      </div>
    </div>
  )
}
