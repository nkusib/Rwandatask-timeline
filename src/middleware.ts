...
const PROTECTED_ROUTES = ['/dashboard', '/send', '/transactions', '/recipients', '/verify', '/settings', '/profile']
...
export async function middleware(req: NextRequest) {
  ...
  res.headers.set('X-XSS-Protection', '0') // Let CSP do the work
...
export const config = {
  matcher: [
    '/((?!_next/static|_next/image|favicon.ico|manifest.json|icons|api/stripe).*)',
  ],
}
